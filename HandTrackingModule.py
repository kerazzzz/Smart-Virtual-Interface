...
class handDetector():
    ...
    # New method to calculate distance between two landmarks
    def findDistance(self, id1, id2, img, draw=True):
        # Get the landmarks for both points
        ...
        return length, img, [x1, y1, x2, y2]  # Return the length, the image, and coordinates of the points
